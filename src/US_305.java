...
public class US_305 extends BaseDriver {
     ...
     public void Test1() throws AWTException, IOException {
          ...
          Assert.assertTrue(element3.getText().contains("Demo"), "Doğru Ürün Eklenmedi");
          ...
          Assert.assertTrue(element5.getText().contains("is confirmed"), "Order Confirmation is not ok");
